...
<html lang="en">
  ...
  >
    <div class="modal-dialog">
      <form action="crudFeatured.php" method="POST" enctype="multipart/form-data">
  ...
  <?php
     if(isset($_GET['edit']) && $_GET['edit']>0){
      $query="SELECT * FROM `featured` WHERE `id`='$_GET[edit]'";
      $result = mysqli_query($con, $query);
    ...
    <script>
      function confirm_rem(id){
       if(confirm("Are you sure, you want to delete this item ?")){
        window.location.href="crudFeatured.php?rem="+id;
       } 
      }
    </script>
